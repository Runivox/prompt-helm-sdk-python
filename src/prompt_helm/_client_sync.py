"""Synchronous PromptHelm client implementation."""
...
from ._retry import with_retry_sync
...
class PromptHelm:
    """Synchronous HTTP client for the PromptHelm gateway."""
    ...
    def _execute_once(self, body: dict[str, Any]) -> ExecuteResponse:
        try:
